...
class CrackerChase:
    ...
    def play_game(self):
        ...
        background_image = pygame.image.load("projects/games/test/background.png")
        self.background_sprite = Sprite(image=background_image,
                                        game=self)

        self.sprites.append(self.background_sprite)

        cracker_image = pygame.image.load("projects/games/test/craker.png")
        ...
        cheese_image = pygame.image.load("projects/games/test/Cheese.png")
