...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE:
                ...
                x+=80
    #downs
    if a[1]==True and a[6]==True and a[12]==True and a[18]==True:
        running=False
    elif a[6]==True and a[12]==True and a[18]==True and a[24]==True:
        running=False
    elif a[12]==True and a[18]==True and a[24]==True and a[30]==True:
        running=False
    elif a[18]==True and a[24]==True and a[30]==True and a[36]==True:
        running=False
        ...
        running=False
    elif a[13]==True and a[19]==True and a[25]==True and a[3]==True:
        running=False
    elif a[19]==True and a[25]==True and a[3]==True and a[37]==True:
        running=False
        ...
        running=False
    elif a[20]==True and a[26]==True and a[32]==True and a[38]==True:
        running=False
        ...
        running=False
    elif a[21]==True and a[27]==True and a[33]==True and a[39]==True:
        running=False
        ...
        running=False
    elif a[22]==True and a[28]==True and a[34]==True and a[40]==True:
        running=False
        
    elif a[0]==True and a[11]==True and a[17]==True and a[23]==True:
        running=False
    elif a[11]==True and a[17]==True and a[23]==True and a[29]==True:
        running=False
    elif a[17]==True and a[23]==True and a[29]==True and a[35]==True:
        running=False
    elif a[23]==True and a[29]==True and a[35]==True and a[41]==True:
        running=False


    #up's        
    elif a[1]==True and  a[2] ==True and a[3]==True and a[4]==True:
        running=False
    elif a[2]==True and  a[3] ==True and a[4]==True and a[5]==True:
        running=False
    elif a[3]==True and  a[4] ==True and a[5]==True and a[0]==True:
        running=False
        ...
        running=False
    elif a[8]==True and  a[9] ==True and a[10]==True and a[11]==True:
        running=False
        ...
        running=False
    elif a[14]==True and  a[15] ==True and a[16]==True and a[17]==True:
        running=False
        ...
        running=False
    elif a[20]==True and  a[21] ==True and a[22]==True and a[23]==True:
        running=False
        ...
        running=False
    elif a[26]==True and  a[27] ==True and a[28]==True and a[29]==True:
        running=False

    elif a[30]==True and  a[3] ==True and a[32]==True and a[33]==True:
        running=False
    elif a[3]==True and  a[32] ==True and a[33]==True and a[34]==True:
        running=False
    elif a[32]==True and  a[33] ==True and a[34]==True and a[35]==True:
        running=False
        
    elif a[36]==True and  a[37] ==True and a[38]==True and a[39]==True:
        running=False
    ...
    #posative diagnels 
        ...
        running = False
    elif a[3] == True and a[9]== True and a[16] == True and a[23] == True:
        running = False
        ...
        running = False
    elif a[8] == True and a[15]== True and a[22] == True and a[29] == True:
        running = False
        ...
        running = False
    elif a[14] == True and a[21]== True and a[28] == True and a[35] == True:
        running = False

    elif a[18]==True and a[25] == True and a[32] == True and a[39] == True: 
        running=False
    elif a[19] == True and a[26] == True and a[33] == True and a[40] == True:
        running = False
    elif a[20] == True and a[27]== True and a[34] == True and a[41] == True:
        running = False

    #negative  diagnels 
    elif a[0]==True and a[10] == True and a[15] == True and a[20] == True: 
        running=False
    elif a[5] == True and a[9] == True and a[14] == True and a[19] == True:
        running = False
    elif a[4] == True and a[8]== True and a[13] == True and a[18] == True:
        running = False
        
    elif a[11]==True and a[16] == True and a[21] == True and a[26] == True: 
        running=False
    ...
    elif a[17]==True and a[22] == True and a[27] == True and a[32] == True: 
        running=False
    elif a[16] == True and a[21] == True and a[26] == True and a[3] == True:
        running = False
    elif a[15] == True and a[20]== True and a[25] == True and a[30] == True:
        running = False

    elif a[23]==True and a[28] == True and a[33] == True and a[38] == True: 
        running=False
    elif a[22] == True and a[27] == True and a[32] == True and a[37] == True:
        running = False
    elif a[21] == True and a[26]== True and a[3] == True and a[36] == True:
        running = False
        ...
        running=False
    elif a[18]==False and a[24]==False and a[30]==False and a[36]==False:
        running=False
        ...
        running=False
    elif a[13]==False and a[19]==False and a[25]==False and a[3]==False:
        running=False
    elif a[19]==False and a[25]==False and a[3]==False and a[37]==False:
        running=False
        ...
        running=False
    elif a[20]==False and a[26]==False and a[32]==False and a[38]==False:
        running=False
        ...
        running=False
    elif a[21]==False and a[27]==False and a[33]==False and a[39]==False:
        running=False
        ...
        running=False
    elif a[22]==False and a[28]==False and a[34]==False and a[40]==False:
        running=False
        
    elif a[0]==False and a[11]==False and a[17]==False and a[23]==False:
        running=False
    elif a[11]==False and a[17]==False and a[23]==False and a[29]==False:
        running=False
    elif a[17]==False and a[23]==False and a[29]==False and a[35]==False:
        running=False
    elif a[23]==False and a[29]==False and a[35]==False and a[41]==False:
        running=False


    #up's        
    elif a[1]==False and  a[2] ==False and a[3]==False and a[4]==False:
        running=False
    elif a[2]==False and  a[3] ==False and a[4]==False and a[5]==False:
        running=False
    elif a[3]==False and  a[4] ==False and a[5]==False and a[0]==False:
        running=False
        ...
        running=False
    elif a[8]==False and  a[9] ==False and a[10]==False and a[11]==False:
        running=False
        ...
        running=False
    elif a[14]==False and  a[15] ==False and a[16]==False and a[17]==False:
        running=False
        ...
        running=False
    elif a[20]==False and  a[21] ==False and a[22]==False and a[23]==False:
        running=False
        ...
        running=False
    elif a[26]==False and  a[27] ==False and a[28]==False and a[29]==False:
        running=False

    elif a[30]==False and  a[3] ==False and a[32]==False and a[33]==False:
        running=False
    elif a[3]==False and  a[32] ==False and a[33]==False and a[34]==False:
        running=False
    elif a[32]==False and  a[33] ==False and a[34]==False and a[35]==False:
        running=False
        
    elif a[36]==False and  a[37] ==False and a[38]==False and a[39]==False:
        running=False
    ...
    #posative diagnels 
        ...
        running = False
    elif a[3] == False and a[9]== False and a[16] == False and a[23] == False:
        running = False
        ...
        running = False
    elif a[8] == False and a[15]== False and a[22] == False and a[29] == False:
        running = False
        ...
        running = False
    elif a[14] == False and a[21]== False and a[28] == False and a[35] == False:
        running = False

    elif a[18]==False and a[25] == False and a[32] == False and a[39] == False: 
        running=False
    elif a[19] == False and a[26] == False and a[33] == False and a[40] == False:
        running = False
    elif a[20] == False and a[27]== False and a[34] == False and a[41] == False:
        running = False

    #negative  diagnels 
    elif a[0]==False and a[10] == False and a[15] == False and a[20] == False: 
        running=False
    elif a[5] == False and a[9] == False and a[14] == False and a[19] == False:
        running = False
    elif a[4] == False and a[8]== False and a[13] == False and a[18] == False:
        running = False
        
    elif a[11]==False and a[16] == False and a[21] == False and a[26] == False: 
        running=False
    ...
    elif a[17]==False and a[22] == False and a[27] == False and a[32] == False: 
        running=False
    elif a[16] == False and a[21] == False and a[26] == False and a[3] == False:
        running = False
    elif a[15] == False and a[20]== False and a[25] == False and a[30] == False:
        running = False

    elif a[23]==False and a[28] == False and a[33] == False and a[38] == False: 
        running=False
    elif a[22] == False and a[27] == False and a[32] == False and a[37] == False:
        running = False
    elif a[21] == False and a[26]== False and a[3] == False and a[36] == False:
        running = False
